...
LDLIBSOPTIONS=-L../Common/dist/win32Release/MinGW-Windows -lCommon

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libGeometry.dll

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libGeometry.dll: ../Common/dist/win32Release/MinGW-Windows/libCommon.dll
...
${OBJECTDIR}/Brush.o: Brush.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Brush.o Brush.cpp
