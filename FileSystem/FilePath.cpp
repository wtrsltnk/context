...
const FilePath& FilePath::operator = (
    const FilePath& other)
{
...
fs::Package* FilePath::openAsPackage(
    int flags)
{
    fs::Package* p = nullptr;
