...
${OBJECTDIR}/PackageFromWad.o: PackageFromWad.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PackageFromWad.o PackageFromWad.cpp

${OBJECTDIR}/PackageFromPak.o: PackageFromPak.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PackageFromPak.o PackageFromPak.cpp
...
${OBJECTDIR}/FileFromMemory.o: FileFromMemory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FileFromMemory.o FileFromMemory.cpp

${OBJECTDIR}/FilePath.o: FilePath.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FilePath.o FilePath.cpp
