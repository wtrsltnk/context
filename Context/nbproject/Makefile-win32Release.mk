...
LDLIBSOPTIONS=../Common/dist/win32Release/MinGW-Windows/libCommon.so -lgdi32

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libContext.dll

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libContext.dll: ../Common/dist/win32Release/MinGW-Windows/libCommon.so
...
${OBJECTDIR}/UserInput.o: UserInput.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../Common  -MMD -MP -MF $@.d -o ${OBJECTDIR}/UserInput.o UserInput.cpp

${OBJECTDIR}/GlContext.o: GlContext.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../Common  -MMD -MP -MF $@.d -o ${OBJECTDIR}/GlContext.o GlContext.cpp
